...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signupConfirmTextController ??= TextEditingController();
    _model.signupConfirmFocusNode ??= FocusNode();
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .signupConfirmTextController,
                                          focusNode:
                                              _model.signupConfirmFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.done,
                                          obscureText:
                                              !_model.signupConfirmVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.signupPasswordTextController.text !=
                                  _model.signupConfirmTextController.text) {
